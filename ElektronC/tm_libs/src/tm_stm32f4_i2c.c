...
uint8_t TM_I2C_ReadReg(I2C_TypeDef* I2Cx, uint8_t address, uint8_t reg) {
...
uint8_t TM_I2C_Read(I2C_TypeDef* I2Cx, uint8_t address) {
	uint8_t received_data;
	TM_I2C_Start(I2Cx, address, I2C_Direction_Receiver, 0);
	received_data = TM_I2C_ReadNack(I2Cx);
	return received_data;
...
void TM_I2C_WriteReg(I2C_TypeDef* I2Cx, uint8_t address, uint8_t reg, uint8_t data) {
	TM_I2C_Start(I2Cx, address, I2C_Direction_Transmitter, 0);
	TM_I2C_WriteData(I2Cx, reg);
...
void TM_I2C_Write(I2C_TypeDef* I2Cx, uint8_t address, uint8_t data) {
	TM_I2C_Start(I2Cx, address, I2C_Direction_Transmitter, 0);
	TM_I2C_WriteData(I2Cx, data);
	TM_I2C_Stop(I2Cx);
}
